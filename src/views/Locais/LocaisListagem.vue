  ...
  <div class="p-4">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
      <TableComponent>
        ...
        <tbody>
          <tr
            v-for="location in storeLocales.locations"
            :key="location.id"
          ...
          >
            ...
            <td class="px-6 py-4 text-right">
              <a
                ...
                @click="storeLocales.deleteLocation(location.id)"
                class="font-medium mr-3 text-red-600 dark:text-red-500 hover:underline"
                >Deletar</a
              >
              <a
                href="javascript:void(0)"
                @click="editarUsuario(location.id)"
    ...
    <Modal
      ref="modalNovoLocal"
      modalName="Novo local"
      buttonName="Novo local"
      colorButton="bg-blue-700"
    >
