  ...
  <div class="p-0">
    <FormContainer @submit="submited">
      <FormRow>
        <FormCol>
          <InputTextForm
            v-model="storeUsers.dataUserStore.name"
            label="Nome"
            type="text"
            placeholder="Nome"
            required
          />
          <InputTextForm
            v-model="storeUsers.dataUserStore.color"
            label="Cor"
            type="text"
            placeholder="Cor"
            required
          />
          <InputTextForm
            v-model="storeUsers.dataUserStore.category"
            label="Categoria"
            type="text"
          ...
          />
          <InputTextForm
            v-model="storeUsers.dataUserStore.price"
            label="Preço"
            type="number"
            placeholder="Preço"
            required
